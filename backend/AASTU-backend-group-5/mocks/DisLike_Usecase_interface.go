...
// DisLike_Usecase_interface is an autogenerated mock type for the DisLike_Usecase_interface type
type DisLike_Usecase_interface struct {
	mock.Mock
}
...
func NewDisLike_Usecase_interface(t interface {
	mock.TestingT
	Cleanup(func())
}) *DisLike_Usecase_interface {
	mock := &DisLike_Usecase_interface{}
	mock.Mock.Test(t)
