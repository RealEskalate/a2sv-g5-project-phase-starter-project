...
// Like_Usecase_interface is an autogenerated mock type for the Like_Usecase_interface type
type Like_Usecase_interface struct {
	mock.Mock
}

// CreateLike provides a mock function with given fields: user_id, post_id
func (_m *Like_Usecase_interface) CreateLike(user_id string, post_id string) error {
...
func NewLike_Usecase_interface(t interface {
	mock.TestingT
	Cleanup(func())
}) *Like_Usecase_interface {
	mock := &Like_Usecase_interface{}
	mock.Mock.Test(t)
