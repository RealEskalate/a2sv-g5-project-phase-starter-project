...
// ComparePassword provides a mock function with given fields: password, hashedPassword
func (_m *PasswordService) ComparePassword(password string, hashedPassword string) bool {
...
func (_m *PasswordService) ValidateEmail(email string) error {
	ret := _m.Called(email)
...
func (_m *PasswordService) ValidatePassword(password string) error {
	ret := _m.Called(password)
