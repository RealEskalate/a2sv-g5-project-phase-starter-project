...
// CreateIndex provides a mock function with given fields: ctx, model, opts
func (_m *Collection) CreateIndex(ctx context.Context, model primitive.D, opts ...*options.CreateIndexesOptions) (string, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 string
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, primitive.D, ...*options.CreateIndexesOptions) (string, error)); ok {
		return rf(ctx, model, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, primitive.D, ...*options.CreateIndexesOptions) string); ok {
		r0 = rf(ctx, model, opts...)
	} else {
		r0 = ret.Get(0).(string)
	}

	if rf, ok := ret.Get(1).(func(context.Context, primitive.D, ...*options.CreateIndexesOptions) error); ok {
