...
type UserUsecase interface {
	Promote(c context.Context, id string) (User, error)
	GetUserProfile(c context.Context, id string) (User, error)
	UpdateUserProfile(c context.Context, id string, user UserUpdate) (User, error)
	DeleteUserprofile(c context.Context, id string) error
	GetProfileImage(c context.Context, id string) (string, error)
}
