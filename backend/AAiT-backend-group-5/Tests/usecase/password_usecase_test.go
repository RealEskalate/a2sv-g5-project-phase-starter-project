...
// func (suite *SetupPasswordTestSuite) TestSetPasswordSuccess() {
// 	shortURLCode := "shortURLCode"
// 	password := "newpassword"
// 	token := "token123"
// 	user := &models.User{ID: "user123"}
// 	hashedPassword := "hashedPassword"
// 	urlData := &models.URLData{Token: token}
...
// 	suite.mockUserRepository.EXPECT().
// 		UpdateUser(context.Background(), user, user.ID).
// 		Return(nil)
