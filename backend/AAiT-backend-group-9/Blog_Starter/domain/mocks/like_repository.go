...
func (_m *LikeRepository) LikeBlog(c context.Context, like *domain.Like) (*domain.Like, error) {
...
func (_m *LikeRepository) UnlikeBlog(c context.Context, likeID string) (*domain.Like, error) {
