...
func (_m *OtpUsecase) GetByID(c context.Context, id string) (domain.Otp, error) {
	ret := _m.Called(c, id)
...
func (_m *OtpUsecase) GetOtpByEmail(c context.Context, email string) (domain.Otp, error) {
...
func (_m *OtpUsecase) InvalidateOtp(c context.Context, otp *domain.Otp) error {
	ret := _m.Called(c, otp)
...
func (_m *OtpUsecase) SaveOtp(c context.Context, otp *domain.Otp) error {
	ret := _m.Called(c, otp)
...
func NewOtpUsecase(t interface {
	mock.TestingT
	Cleanup(func())
}) *OtpUsecase {
	mock := &OtpUsecase{}
