...
func (uc *BlogUsecase) LikeBlog(blogId,userId string){
	uc.blogRepository.LikeBlog(blogId, userId)
}
func (uc *BlogUsecase) DislikeBlog(blogId,userId string){
	uc.blogRepository.DislikeBlog(blogId, userId)
}
func (uc *BlogUsecase) ViewsBlogs(blogId,userId string){
	uc.blogRepository.AddView(blogId, userId)
}
