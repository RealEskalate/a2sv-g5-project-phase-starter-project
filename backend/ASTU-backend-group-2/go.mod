module github.com/a2sv-g5-project-phase-starter-project/backend/ASTU-backend-group-2
...
require (
	github.com/Scalingo/go-handlers v1.8.2 // indirect
	github.com/Scalingo/go-utils v7.1.0+incompatible // indirect
