...
import 'package:ecommerce_app/features/product/presentation/pages/add_product_page.dart';
...
void main() {
  ...
  testWidgets('add product page ...', (tester) async {
    await tester.pumpWidget(pageTester(AddProductPage()));

    final addImage = find.byIcon(Icons.image_outlined);
    ...
    expect(catagory, findsOneWidget);
