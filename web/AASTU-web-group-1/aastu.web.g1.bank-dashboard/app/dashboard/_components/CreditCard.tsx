      ...
      <div className="w-[265px] min-w-[265px] h-[170px] bg-gradient-to-r from-[#423fee] to-[#2723f1] rounded-xl pt-3 space-y-5 border border-gray-300">
        <div className="flex justify-between px-5">
          <div className="block text-white space-y-[1px]">
            <p className="text-[11px]" style={{ fontWeight: 100 }}>
              Balance
            </p>
            <p className="text-[16px]" style={{ fontWeight: 100 }}>
              $5,756
            </p>
          </div>
        ...
        <div className="flex justify-between px-5">
          <div className="block space-y-[1px]">
            <p className="text-[10px] text-gray-400" style={{ fontWeight: 100 }}>
              CARD HOLDER
            </p>
            <p className="text-[13px] text-white" style={{ fontWeight: 100 }}>
              Eddy Cusuma
            </p>
          </div>
          <div className="block space-y-[1px]">
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-between px-5 items-center py-1">
            <p className="text-[15px] text-white" style={{ fontWeight: 100 }}>
              3778*** ****1234
            </p>
            <Image
