...
export default function InvestmentCard(props:any){
  return (
    <div className="flex bg-white rounded-3xl mb-2 w-[90%] md:w-full h-[100px] mx-auto p-2 justify-between">
      ...
      <div className='my-auto w-[50%] md:w-[30%]'>
        <h1 className='text-[14px] md:text-[16px] font-[600] pb-1' >{props.name}</h1>
      ...
      <div className='my-auto w-[30%] hidden lg:table-cell'>
        <h1 className='text-[14px] md:text-[16px] font-[600] pb-1' >{props.investmentValue}</h1>
        <p className='text-blue-800 text-[10px] md:text-[16px]'>Envestment Value</p>
      </div>
      <div className='my-auto w-[40%] md:w-[30%] pl-16 md:pl-0'>
        <h1 className='text-emerald-700 text-[14px] md:text-[16px] font-[600] pb-1'>{props.returnValue}</h1>
