  ...
  return (
    ...
    >
      <div className="flex ml-1  gap-1">
        ...
        <div className="px-2">
          <div
            className={`mt-1 font-medium ${isDarkMode ? "text-white" : ""} `}
          >
            {name}
          </div>
      ...
      <div className="hidden md:flex justify-between gap-4 w-1/2">
        <div className="px-2">
          <div className={`mt-1 font-medium ${isDarkMode ? "text-white" : ""}`}>
            Business loans
          </div>
          <div className="text-xs text-[#718EBF]">
            it&apos;s a long established
      ...
      <div className="text-[#1814F3] text-sm font-bold lg:border-2 lg:border-gray-200 lg:px-6 lg:rounded-full lg:my-auto lg:py-1 ">
        View Detail
      </div>
    </div>
  );
