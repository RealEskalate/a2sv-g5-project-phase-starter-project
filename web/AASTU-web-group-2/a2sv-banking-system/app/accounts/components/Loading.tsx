...
const Loading = () => {
  return (
    <>
      <div className="flex flex-col h-full bg-[#F5F7FA] dark:bg-[#050914] px-3 py-3 gap-5">
        ...
        <div className="flex flex-col md:flex-row gap-5">
          <div className="flex flex-col gap-5 md:w-1/2">
            <span className="text-xl bg-gray-300 dark:bg-[#333B69] font-semibold w-24 h-5 rounded-lg"></span>
            <div className="bg-white dark:bg-[#1c223a] flex flex-col justify-between rounded-2xl animate-pulse p-4">
              <div className="w-full h-10 bg-gray-200 dark:bg-[#333B69] rounded mb-4"></div>
              <div className="w-full h-10 bg-gray-200 dark:bg-[#333B69] rounded mb-4"></div>
              <div className="w-full h-10 bg-gray-200 dark:bg-[#333B69] rounded mb-4"></div>
              <div className="w-full h-10 bg-gray-200 dark:bg-[#333B69] rounded"></div>
            </div>
          </div>
          ...
          <div className="md:w-1/2 gap-1 flex flex-col">
            <div className="flex justify-between mr-2">
              <span className="text-xl bg-gray-300 dark:bg-[#333B69] font-semibold w-24 h-5 rounded-lg"></span>
              <span className="text-xl bg-gray-300 dark:bg-[#333B69] font-semibold w-10 h-5 rounded-lg"></span>
            </div>
        ...
        <div className="flex flex-col md:flex-row gap-5">
          <div className="flex flex-col gap-5 md:w-1/2">
            <span className="text-xl bg-gray-300 dark:bg-[#333B69] font-semibold w-24 h-5 rounded-lg"></span>
            <div className="w-full h-64 bg-gray-200 dark:bg-[#333B69] rounded-2xl animate-pulse"></div>
          </div>
          <div className="flex flex-col gap-5 md:w-1/2">
            <span className="text-xl bg-gray-300 dark:bg-[#333B69] font-semibold w-24 h-5 rounded-lg"></span>
            <div className="bg-white dark:bg-[#1c223a] flex flex-col justify-between rounded-2xl animate-pulse p-4">
