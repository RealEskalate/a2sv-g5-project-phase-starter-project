...
const CreditCard: React.FC<CardProps> = ({
  ...
  if (loading) {
    return (
      <div className='border rounded-3xl my-4 mx-2'>
        <div className='relative w-full bg-gradient-to-b from-gray-200 to-gray-300 rounded-3xl shadow-md font-lato pt-6 min-w-[350px] shimmer'>
          ...
          <div className="relative mt-8 flex justify-between py-4 items-center">
            <div className="w-full h-6 bg-gray-300 rounded mx-6"></div>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className='border rounded-3xl my-4 mx-2'>
      <div className={`relative w-full bg-gradient-to-b ${bgColor} ${textColor} rounded-3xl shadow-md font-lato pt-6 min-w-[350px]`}>
        <div className="flex justify-between items-start px-6">
          <div>
