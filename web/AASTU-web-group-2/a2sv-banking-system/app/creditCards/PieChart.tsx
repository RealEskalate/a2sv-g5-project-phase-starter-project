...
export function PieChartPage() {
  ...
  return (
    <div className="flex flex-col gap-5 bg-white rounded-2xl py-3 justify-center px-4 items-center shadow-sm h-full dark:bg-[#020817] dark:border dark:border-[#333B69] dark:shadow-2xl">
      <Card
        data-chart={id}
