export const ShimmerCreditCard = () => {
  return (
    <div className="flex justify-around items-center bg-gray-200 dark:bg-gray-700 p-3 lg:p-4 rounded-2xl shadow-sm animate-pulse">
      <div className="w-10 h-10 bg-gray-300 dark:bg-gray-600 rounded-full"></div>
      <div className="flex gap-9">
        <div>
          <div className="bg-gray-300 dark:bg-gray-600 h-4 w-24 rounded"></div>
          <div className="bg-gray-200 dark:bg-gray-700 h-3 w-20 mt-2 rounded"></div>
        </div>
      ...
      <div className="bg-gray-300 dark:bg-gray-600 h-5 w-16 rounded"></div>
    </div>
  );
};
...
export const ShimmerPieChartPage = () => {
  return (
    <div className="flex flex-col gap-5 bg-white dark:bg-gray-800 rounded-2xl py-3 justify-center px-4 items-center shadow-sm h-full animate-pulse">
      <div className="flex flex-col w-52 shadow-none bg-transparent border-none">
        <div className="mx-auto aspect-square w-full max-w-[300px] bg-gray-200 dark:bg-gray-700 rounded-full"></div>
