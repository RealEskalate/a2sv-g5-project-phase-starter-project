    ...
    <div className = " border rounded-3xl my-4 mx-4">
      ...
      <div className="flex flex-col gap-3 px-5 py-5">
        {/*  Image Component  */}
            ...
            <div className="flex  text-[#718EBF] text-xs justify-between items-center text-nowrap  mr-3">
              <p>Write Amount</p>
              <div className="flex gap-6 bg-[#EDF1F7] rounded-full ">
                    <div className=" bg-[#EDF1F7] rounded-full flex  items-center  px-5 py-3 flex-1">
                      <p>525.50</p>
                    </div>
                    <div className="">
