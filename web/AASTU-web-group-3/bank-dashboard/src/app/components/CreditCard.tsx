...
export default function CreditCard({
  ...
  const masterCardDarker =
    backgroundImg === "bg-white" ? "/Icons/masterCardLogoDarker.svg" : "/Icons/masterCardLogo.svg";
  const sCard = backgroundImg === "bg-white" ? "/Icons/simCardDarker.svg" : "/Icons/simCard.svg";
  const cardText =
