  ...
  return (
    <div className="body flex  md:w-auto w-auto h-auto p-2 border-[1px] rounded-[10px] m-2 bg-white">
      ...
      <div className="right w-full flex justify-between items-center p-2">
        <div>
          <div className="font-medium text-sm md:text-[12px]">Card Type</div>
          <div className="font-normal text-xs text-[#718EBF]">{cardType}</div>
        </div>
        <div>
          <div className="font-medium text-sm md:text-[12px]">Bank</div>
          <div className="font-normal text-xs text-[#718EBF]">{bank}</div>
        </div>
        <div className="hidden md:block">
          <div className="font-medium text-sm md:text-[12px]">Card Number</div>
          <div className="font-normal text-xs text-[#718EBF]">{cardNumber}</div>
        </div>
        <div className="hidden md:block">
          <div className="font-medium text-sm md:text-[12px]">Namain Card</div>
          <div className="font-normal text-xs text-[#718EBF]">{NamainCard}</div>
        </div>
        <div>
          <Link
            href={detailsLink}
