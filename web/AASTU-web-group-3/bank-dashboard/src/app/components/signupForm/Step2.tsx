...
const Step2: React.FC<StepProps> = ({ step }) => {
  ...
  return (
    <div className="space-y-4 min-h-[350px] flex flex-col justify-between">
      ...
      <div>
        <label className="block text-sm font-medium">Permanent Address <span className="text-red-500">*</span></label>
        <input
          {...register('permanentAddress', { required: 'Permanent Address is required' })}
          className="mt-1 p-2 block w-full border rounded-md"
        />
        {errors.permanentAddress && <p className="text-red-500 text-sm mt-1">{String(errors.permanentAddress.message)}</p>}
      </div>
      <div>
        ...
        <input
          ...
          className="mt-1 p-2 block w-full border rounded-md"
        />
        {errors.postalCode && <p className="text-red-500 text-sm mt-1">{String(errors.postalCode.message)}</p>}
      </div>
      <div>
        <label className="block text-sm font-medium">Present Address <span className="text-red-500">*</span></label>
        <input
          {...register('presentAddress', { required: 'Present Address is required' })}
          className="mt-1 p-2 block w-full border rounded-md"
        />
        {errors.presentAddress && <p className="text-red-500 text-sm mt-1">{String(errors.presentAddress.message)}</p>}
      </div>
      <div>
