...
>>>>>>> b7d262c3b2d569ff8351bc0dc6e00845a35cef3c
  ...
  return (
    <div className="bg-[#F5F7FA] min-h-screen p-5">
      <div className="lg:flex lg:space-x-8">
        <div className="lg:w-3/4 lg:flex lg:space-x-8 overflow-x-auto flex bg-[#F5F7Fa]">
          <div className="flex-shrink-0 rounded-lg w-full h-60 lg:h-56 lg:w-1/2 lg:rounded-r-none">
            <CreditCard
              name="Karthik P"
              balance="$5,756"
          ...
          <div className="flex-shrink-0 rounded-lg lg:w-1/2 lg:rounded-l-none h-60 lg:h-56 w-full">
            <CreditCard
              name="Karthik P"
              balance="$5,756"
              cardNumber="3778 **** **** 1234"
