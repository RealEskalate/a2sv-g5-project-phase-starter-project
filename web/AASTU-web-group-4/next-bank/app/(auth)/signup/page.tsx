        ...
        <div className="grid gap-6 sm:grid-cols-1 md:grid-cols-2">
          ...
          <div className="md:row-span-2">
            ...
            {errors.permanentAddress && (
              <p className="text-red-500 mt-1">{errors.permanentAddress.message}</p>
            )}
          </div>
        ...
        <div className="grid gap-6 sm:grid-cols-1 md:grid-cols-2">
          ...
          <div>
            ...
            {errors.presentAddress && (
              <p className="text-red-500 mt-1">{errors.presentAddress.message}</p>
            )}
          </div>
          ...
          <div>
            ...
            {/* profilePicture */}
            <div>
              <label htmlFor="profilePicture" className="mb-3 font-medium text-gray-700">
                Profile Picture
              </label>
              <input
                type="file"
            ...
            <div>
              ...
              {errors.preference?.currency && (
                <p className="text-red-500 mt-1">{errors.preference.currency.message}</p>
              )}
            </div>
            ...
            <div>
                <label htmlFor="sentOrReceiveDigitalCurrency" className="font-medium pr-3 text-gray-700">Sent or Receive Digital Currency</label>
                <input
                  type="checkbox"
              ...
              <div>
                <label htmlFor="receiveMerchantOrder" className="font-medium pr-3 text-gray-700">Receive Merchant Order</label>
                <input
                  type="checkbox"
              ...
              <div>
                <label htmlFor="accountRecommendations" className="font-medium pr-3 text-gray-700">Account Recommendations</label>
                <input
                  type="checkbox"
            ...
            <div className="md:row">
              <label htmlFor="twoFactorAuthentication" className="pr-3 font-medium text-gray-700">Enable Two-Factor Authentication</label>
              <input
                type="checkbox"
