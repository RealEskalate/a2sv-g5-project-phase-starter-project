...
const SignupForm = () => {
  ...
  const onSubmit = (data: User) => {
    ...
    handleRegister(data); // Call handleRegister with the submitted data
  };
      ...
      {step === 1 && (
        <div className="grid gap-6 sm:grid-cols-1 md:grid-cols-2">
          ...
          <div className="md:col-span-2 flex justify-center">
            ...
            <Link href="/signin" className="text-blue-800">Login
            </Link>
          </div>
        </div>
      )}  
      ...
      {step === 2 && (
        <div className="grid gap-6 sm:grid-cols-1 md:grid-cols-2">
          ...
          <div>
            ...
            {errors?.preference?.currency && <p className="text-red-500 mt-1">{errors?.preference?.currency.message}</p>}
          </div>
