...
const CardSetting = () => {
  ...
  return (
    <div className='md:w-[335px] md:h-[470px] w-[330px] h-[450px] rounded-3xl bg-white pt-4  dark:bg-dark text-gray-900 dark:text-white dark:border-[1px] dark:border-gray-700'>
