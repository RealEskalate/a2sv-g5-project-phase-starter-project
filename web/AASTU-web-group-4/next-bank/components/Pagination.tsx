  ...
  return (
    <div className="flex justify-center items-center my-6 space-x-2">
      ...
      {pages.map(page => (
        <button
          key={page}
          className={`px-4 py-2 border rounded-lg shadow-sm ${page === currentPage ? 'bg-blue-600 text-white' : 'bg-transparent text-blue-500 border-blue-500 hover:bg-blue-100'} transition-colors duration-200`}
