...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      "fixed inset-0 z-50 bg-black/80  data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-5 data-[state=open]:fade-in-5 backdrop-brightness-50 backdrop-blur-[10px]",
      className
    )}
    {...props}
  />
