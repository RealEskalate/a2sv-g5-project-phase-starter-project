...
export default function Component() {
  ...
  return (
    <Card className={`relative h-[364px] w-full ${darkmode ? 'bg-gray-800 text-white' : 'bg-white text-black'}`}>
      {/* Color Titles at the Top Right */}
      <div className={`absolute top-0 right-0 p-2 flex gap-2 ${darkmode ? 'bg-gray-800' : 'bg-white'}`}>
