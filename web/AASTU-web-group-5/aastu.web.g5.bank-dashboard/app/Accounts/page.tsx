...
const Accounts = () => {
  ...
  useEffect(() => {
    ...
    const fetchTransactions = async () => {
      try {
        const response = await axios.get('https://bank-dashboard-rsf1.onrender.com/transactions?page=0&size=10', {
          headers: {
            Authorization: token,
          },
        });
    ...
    const fetchBalanceData = async () => {
      try {
        const response = await axios.get('https://bank-dashboard-rsf1.onrender.com/transactions/random-balance-history?monthsBeforeFirstTransaction=2', {
          headers: {
            Authorization: token,
          },
        });
    ...
    const fetchIncomes = async () => {
      try {
        const response = await axios.get('https://bank-dashboard-rsf1.onrender.com/transactions/incomes?page=0&size=5', {
          headers: {
            Authorization: token,
          },
        });
    ...
    const fetchExpenses = async () => {
      try {
        const response = await axios.get('https://bank-dashboard-rsf1.onrender.com/transactions/expenses?page=0&size=3', {
          headers: {
            Authorization: token,
          },
        });
