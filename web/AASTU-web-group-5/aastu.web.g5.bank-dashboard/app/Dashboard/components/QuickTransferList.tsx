  ...
  return (
    <div className='container rounded-[20px] flex flex-col gap-4 p-4 bg-white dark:bg-gray-800 transition-colors duration-300'>
      <div className='flex flex-col md:flex-row justify-between items-center'>
        ...
        <svg className='w-6 h-6 shadow-md mt-2 md:mt-0 dark:stroke-white' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
      ...
      <div className="flex flex-col md:flex-row items-center gap-4">
        <p className="text-sm font-bold w-full md:w-1/2 text-gray-900 dark:text-gray-100">Write Amount</p>
        <div className="relative w-full md:w-1/2">
          <input
            type="text"
            className="w-full p-2 rounded-[50px] border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 pr-12"
            placeholder='525.50'
          />
          <button type="submit" className="absolute right-0 top-0 bottom-0 text-white flex items-center bg-blue-700 dark:bg-blue-900 rounded-[50px] py-2 px-4">
            Send
