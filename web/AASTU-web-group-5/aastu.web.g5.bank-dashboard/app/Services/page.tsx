			...
			<div className="p-5 m-4 space-y-3">
				{services.map((service) => {
					...
					return (
						...
						>
							<div className="bg-white dark:bg-gray-900 h-[70px] rounded-xl flex-grow items-center justify-center sm:shadow-md">
								<div className="flex items-center justify-center p-1 m-0">
									<div className="flex items-center gap-3 w-full">
										...
										<div className="flex-1 sm:flex-none">
											<h3 className="font-inter text-black dark:text-[#fff] text-base font-medium leading-[16.94px] text-left whitespace-nowrap">
												{service.name}
											</h3>
											<p className="sm:font-inter sm:text-xs sm:font-normal sm:leading-[14.52px] sm:text-left text-blue-900 dark:text-gray-300 opacity-60 whitespace-nowrap">
									...
									<div className="flex sm:flex-row items-center justify-between w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto sm:pr-6">
										<div className="hidden sm:flex flex-row gap-4 sm:gap-12 items-start pr-6">
											<div className="flex-col items-center gap-3 w-48">
												...
												<p className="font-inter text-blue-900 dark:text-gray-300 opacity-60">
