...
const Page = () => {
  ...
  return (
    <div className={`bg-[#F5F7FA] w-[95%] dark:bg-gray-900 space-y-8 pt-3 overflow-hidden mx-auto ${darkMode ? "text-white" : "text-black"}`}>
      ...
      <div className="overflow-x-auto">
        <div className="flex flex-nowrap gap-6">
          {loading ? (
            ...
            <>
              <div className="flex-shrink-0 w-full md:w-1/3">
                <div className={`h-32 lg:h-[90px] rounded-xl flex-grow flex justify-center items-center gap-4 ${darkMode ? "bg-gray-800" : "bg-white"} w-full`}>
                  ...
                  <div className="flex flex-col">
                    <h3 className="font-inter text-lg font-medium leading-[16.94px] text-left">Life Insurance</h3>
                    <p className="font-inter opacity-60 text-base">Unlimited Protection</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex-shrink-0 w-full md:w-1/3">
                <div className={`h-32 lg:h-[90px] rounded-xl flex-grow flex justify-center items-center gap-4 ${darkMode ? "bg-gray-800" : "bg-white"} w-full`}>
                  ...
                  <div className="flex flex-col">
                    <h3 className="font-inter text-lg font-medium leading-[16.94px] text-left">Shopping</h3>
                    <p className="font-inter opacity-60 text-base">Buy. Think. Grow.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex-shrink-0 w-full md:w-1/3">
                <div className={`h-32 lg:h-[90px] rounded-xl flex-grow flex justify-center items-center gap-4 ${darkMode ? "bg-gray-800" : "bg-white"} w-full`}>
                  ...
                  <div className="flex flex-col">
                    <h3 className="font-inter text-lg font-medium leading-[16.94px] text-left">Safety</h3>
                    <p className="font-inter opacity-60 text-base">We are all your allies</p>
                  </div>
                </div>
              </div>
            </>
                      ...
                      <div className="hidden sm:flex sm:flex-row items-center justify-between w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto sm:pr-6">
                        <div className="hidden sm:flex flex-row gap-4 sm:gap-12 items-start pr-6">
                          <div className="flex-col items-center gap-3 w-48">
                            <p className={`font-semibold ${darkMode ? "text-white" : "text-black"}`}>Number of Users</p>
                            <p className={`font-inter opacity-60 ${darkMode ? "text-gray-400" : "text-gray-600"}`}>{service.numberOfUsers}</p>
                          </div>
                          <div className="flex-col items-center w-20">
                            <p className={`font-semibold ${darkMode ? "text-white" : "text-black"}`}>Status</p>
                            <p className={`font-inter opacity-60 ${darkMode ? "text-gray-400" : "text-gray-600"}`}>{service.status}</p>
                          </div>
                          <div className="flex-col items-center w-20">
                            <p className={`font-semibold ${darkMode ? "text-white" : "text-black"}`}>Type</p>
                            <p className={`font-inter opacity-60 ${darkMode ? "text-gray-400" : "text-gray-600"}`}>{service.type}</p>
                          </div>
                        </div>
                      </div>
