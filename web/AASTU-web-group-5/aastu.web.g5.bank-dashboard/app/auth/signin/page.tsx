        ...
        <form onSubmit={handleSubmit(onSubmit)} className="w-full flex flex-col items-center gap-4 sm:gap-6 md:gap-8">
          <div className="mb-4 w-full flex justify-center">
            <input
              ...
              className="input-field w-full sm:max-w-lg md:max-w-[70%] lg:max-w-[80%] bg-blue-50 border border-blue-300 rounded-full p-2 transition duration-300 ease-in-out focus:bg-blue-100"
            />
            {errors.userName && <p className="error-text text-red-500">{errors.userName.message}</p>}
          </div>
          ...
          <div className="mb-4 w-full flex justify-center">
            <input
              ...
              className="input-field w-full sm:max-w-lg md:max-w-[70%] lg:max-w-[80%] bg-blue-50 border border-blue-300 rounded-full p-2 transition duration-300 ease-in-out focus:bg-blue-100"
            />
            {errors.password && <p className="error-text text-red-500">{errors.password.message}</p>}
          </div>
