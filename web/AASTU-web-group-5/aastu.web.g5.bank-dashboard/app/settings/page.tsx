...
function Settings() {
    ...
    return (
        <div className={`rounded-2xl pt-4 w-[95%] text-sm md:text-base justify-center mt-6 px-6 sm:px-10 pb-5 mx-auto ${darkMode ? 'bg-gray-900 text-white' : 'bg-white text-neutral-800'}`}>
