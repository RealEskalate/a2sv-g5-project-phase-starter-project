...
const EditProfile = () => {
	...
	return (
		<div className="bg-white  dark:bg-gray-900 p-4 md:p-8">
			<form onSubmit={handleSubmit}>
					...
					<div className="w-full md:w-[80%] flex flex-col md:flex-row gap-6">
						...
						<div className="w-full md:w-[50%] space-y-6">
							<div className="bg-white dark:bg-gray-900 ">
								<p className="text-black dark:text-gray-400 font-sans text-lg mb-2">
									Your Name
								</p>
								<input
									type="text"
									className="border border-[#DFEAF2] dark:bg-gray-500 dark:text-[#fff] p-2 w-full rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
				...
				<div className="flex justify-center md:justify-end mt-8 md:mt-12">
					<button
						type="submit"
						className="bg-blue-800 text-white w-full h-12 rounded-full md:w-[12rem] text-[13px] md:text-base"
					>
						Save
					</button>
				</div>
