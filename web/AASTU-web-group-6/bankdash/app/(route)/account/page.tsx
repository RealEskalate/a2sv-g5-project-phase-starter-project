    ...
    <div className="w-[96%] flex flex-col grow gap-6 p-5 lg:p-8 pt-6">
      ...
      <div className="flex  flex-col lg:flex-row my-5 justify-between">
        <div className="lg:w-[65%]">
          ...
          <div className=" bg-white border rounded-3xl p-3 shadow-lg border-gray-300 sm:text-[12px]">
            <LastTransList />
          </div>
        </div>
      ...
      <div className="flex flex-col lg:flex-row justify-between my-5">
        ...
        <div className="lg:w-[30%]">
          ...
          <div className="border border-solid rounded-3xl p-3 lg:p-9  bg-white shadow-lg border-gray-300">
            <InvoiceCard
              title="Apple Store"
              date="5h ago"
              amount="$450"
