...
const DescriptionCard: React.FC<DescriptionCardProps> = ({
  ...
  return (
    <div className="lg:ml-10 mb-5 flex items-center justify-between h-24 bg-white lg:gap-5 border rounded-3xl w- ">
      ...
      <button className="text-[#1814F3] font-semibold text-[15px] lg:border lg:border-[#718EBF] lg:w-36 h-8 lg:rounded-[50px] mr-8">
        {btn}
      </button>
    </div>
  );
