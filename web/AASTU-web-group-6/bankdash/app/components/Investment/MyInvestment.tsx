    ...
    <div className="border border-solid rounded-[20px] flex items-center justify-around py-4 mb-5 bg-white dark:bg-[#232328]">
      <div className="flex items-center gap-4 w-[40%]">
        ...
        <div className="flex flex-col ">
          <p className="font-inter text-base font-medium text-[#232323] dark:text-gray-300">
            {title}
          </p>
      ...
      <div className=" hidden lg:block  flex-col w-[20%]">
        <p className="font-inter text-base font-medium text-[#232323] dark:text-blue-400">
          {amount}
        </p>
        <p className="font-inter text-[15px] font-normal text-[#718EBF] dark:text-gray-400">
          {Envestment}
      ...
      <div className="flex flex-col w-[20%]">
        <p className={` font-medium text-base font-inter ${textColor}`}>
          {returnValue}
        </p>
