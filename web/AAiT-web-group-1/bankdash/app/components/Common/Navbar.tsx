...
const Header = () => {
  ...
  const title = pathToTitle[pathname] || "Overview";
      ...
      <div className="w-full md:pl-4 flex">
        <div className="flex flex-row flex-wrap justify-center md:items-center align-middle w-full space-y-4 md:space-y-0 md:ml-60">
          <div className="md:hidden flex justify-start align-middle pt-3 w-1/3 z-40" onClick={handleBurgerClick}>
            <Image className="w-8 h-8 order-1 bg-white" src={hamburger} alt="hamburger" />
          </div>
          ...
          <Image className="w-10 ml-7 h-20 md:block hidden" src={settings} alt="settings" />
          <Image className="w-10 h-20 ml-7 self-end md:block hidden" src={bell} alt="bell" />
          <div className="flex justify-end md:w-fit w-1/3 md:mb-5 order-3 md:order-3 md:ml-7">
            <Image className="w-10 h-10" src={profile} alt="profile_picture" />
          </div>
        </div>
      </div>
    </div>
