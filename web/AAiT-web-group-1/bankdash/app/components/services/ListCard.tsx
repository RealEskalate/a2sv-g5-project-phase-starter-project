...
const ListCard = ({imgpath, heading, status, type, description3={title:'',description: ''}} : ListCardProps) => {
  return (
    <div className='flex bg-white py-3 pl-3 lg:p-4 rounded-2xl mr-4 mb-2 sm:mb-5'>
        <div className='mr-3 lg:mr-8 w-14 lg:w-16 my-auto'>
            <Image src={imgpath} width={60} height={60} alt={`${heading.title} icon`}/>
        </div>
        <div className='grid grid-cols-5 sm:grid-cols-11 w-full'>
            ...
            <div className='my-auto col-span-2 hidden sm:block'>
                <div className='font-medium text-sm sm:text-base lg:text-lg'>Status</div>
                <div className='text-[#718EBF] text-xs lg:text-lg inline-block'>{status}</div>
            </div>
            <div className='my-auto col-span-2 hidden sm:block'>
                <div className='font-medium text-sm sm:text-base lg:text-lg'>Type</div>
                <div className='text-[#718EBF] text-xs lg:text-lg inline-block'>{type}</div>
            </div>
            <div className='my-auto col-span-2 hidden sm:block'>
                <div className='font-medium text-sm sm:text-base lg:text-lg'>{description3.title}</div>
                <div className='text-[#718EBF] text-xs lg:text-lg inline-block'>{description3.description}</div>
            </div>
