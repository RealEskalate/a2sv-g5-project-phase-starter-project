...
const QuickTransfer = () => {
  return (
    <div className="bg-white px-5 py-5 max-w-full max-h-[276px] h-[276px] shadow-md rounded-xl">
      ...
      <div className="flex items-center pt-5 gap-8">
        ...
        <div className=" h-[50px] relative">
          <input
            className="focus:outline-none px-5 bg-[#EDF1F7] h-[50px] rounded-3xl text-[#718EBF]"
            type="text"
          />
