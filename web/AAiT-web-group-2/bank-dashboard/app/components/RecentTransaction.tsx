...
const RecentTransaction = () => {
  return (
    <div className="flex flex-col justify-center my-6 py-5 mx-auto min-w-[231px] min-h-[170px] max-w-[350px] max-h-[235px] bg-white rounded-my-card-radius drop-shadow-sm shadow-md">
      <div className="flex justify-start items-center">
        ...
        <div className="flex flex-col justify-start items-start">
          ...
          <span className="text-custom-light-purple text-[clamp(12px,2.5vw,14px)] ">28 January 2021</span>
        </div>
        <span className="text-custom-red ml-auto mr-6 text-[clamp(11px,2.5vw,16px)]">-$850</span>
      </div>
      <div className="flex justify-start my-3 items-center">
        ...
        <div className="flex flex-col justify-start items-start">
          ...
          <span className="text-custom-light-purple text-[clamp(12px,2.5vw,14px)]">25 January 2021</span>
        </div>
        <span className="text-my-color-8 ml-auto mr-6 text-[clamp(11px,2.5vw,16px)]">+$2,500</span>
      </div>
      <div className="flex justify-start items-center">
        ...
        <div className="flex flex-col justify-start items-start">
          ...
          <span className="text-custom-light-purple text-[clamp(12px,2.5vw,14px)]">21 January 2021</span>
        </div>
        <span className="text-my-color-8 ml-auto mr-6 text-[clamp(11px,2.5vw,16px)]">+$5,400</span>
      </div>
    </div>
  );
};
