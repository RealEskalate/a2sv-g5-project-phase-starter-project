...
const RecentTransactions: React.FC = () => {
  return (
    <div className="overflow-x-auto bg-white rounded-3xl shadow-md p-4 my-2">
      <table className="min-w-full  p-4 font-body">
        ...
        <tbody className='font-medium text-base font-body'>
          {transactions.map((transaction, index) => (
            <tr key={index} className="border-b last:border-none">
              ...
              <td className="px-6 py-4  text-gray-900">{transaction.type}</td>
              <td className="px-6 py-4  text-gray-900">{transaction.card}</td>
              ...
              <td className="px-6 py-4  text-blue-600">
                {transaction.receipt && (
                  <button className="px-2 py-1 font-normal text-sm  text-custom-purple hover:bg-blue-50 border border-custom-purple border-1 rounded-3xl">
                    Download
                  </button>
                )}
              </td>
