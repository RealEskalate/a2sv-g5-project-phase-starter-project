...
const page = () => {
  return (
    <div className='bg-background px-8  w-[1160px] max-md:w-[800px] max-sm:px-6 '> 
        <div className='flex gap-[30px] max-md:gap-[25px] items-center mb-6 text-[#343C6A] max-sm:block'>
            <div className=''>
