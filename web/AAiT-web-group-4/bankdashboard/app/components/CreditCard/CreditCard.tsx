...
const CreditCard = () => {
  return (
    ...
    {/* max-mobile:w-[350px] max-mobile:h-[235px] tablet:w-[231px] table:h-[170px] desktop:w-[350px] desktop:h-[235px] */}
      <div className="h-1/4 ">
        <div className="flex justify-between">
          <div className="flex flex-col">
            ...
            <p className="text-white text-xl font-semibold">$5067</p>
          </div>
      ...
      <div className="flex gap-16 h-1/4 ">
        <div className="flex flex-col">
          <p className="text-white text-xs opacity-70 font-normal">CARD HOLDER</p>
          <p className="text-white text-sm">$Natnael b</p>
        </div>

        <div className="flex flex-col">
          <p className="text-white text-xs opacity-70">VALID THRU</p>
