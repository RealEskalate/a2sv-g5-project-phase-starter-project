...
import { headers , data } from "./table_data";
      ...
      <table>
        <thead className="">
          <tr>
            {headers.map((header, index) => (
              <td key={index} className="py-3 pb-2 px-8 border-b border-gray-400 text-left text-[10pt] text-customBlue">
                {header}
              </td>
            ))}
          </tr>
        ...
        {data.map((row, rowIndex) => (
            <tr key={rowIndex} className="text-[10pt] ">
              ...
              <td className="py-2 px-8 border-b border-gray-200">
                <button className="border border-black px-5 py-1 rounded-[30px] hover:border-blue-800" >
                {row.repay}
        ...
        <tfoot>
          <tr className="text-[10pt] text-red-500">
            ...
            <td className="py-4 px-8 border-t border-gray-200">$33,000</td> {/* Example Total */}
            <td className="py-4 px-8 border-t border-gray-200">$17,000</td> {/* Example Total */}
