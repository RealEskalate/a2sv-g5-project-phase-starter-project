...
const BalanceCard = ({property}: {property: string}) => {
  ...
  return (
    <div className={`w-[300px] mx-auto md:mx-0 md:w-[330px] rounded-3xl px-5 py-3 space-y-5 shadow-md ${property == 'blue' ? 'bg-gradient-to-l from-[#0a06f4] to-[#4c49ed] text-white' : "bg-white"}`}>
        ...
        <div className={` ${property == 'blue' ? "bg-[#4845e8]" : "border-t bg-white"} flex justify-between items-center p-3  rounded-3xl`}>
