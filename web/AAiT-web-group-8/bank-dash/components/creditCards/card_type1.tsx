...
return (
    <div className="flex flex-col w-[350px] h-[235px] text-white">
        <div className="flex flex-col justify-between gap-6 rounded-t-3xl bg-gradient-to-r from-[rgba(76,73,237,1)] to-[rgba(10,6,244,1)]">
        ...
        <div className="flex justify-between items-center align-bottom bg-gradient-to-br from-[rgba(76,73,237,0.8)] to-[rgba(76,73,237,1)] p-6 rounded-b-3xl">
