...
const DebiteAndCredit = () => {
  return (
    <div className="w-full md:w-8/12">
      ...
      <div className="h-[350px] bg-white p-6 rounded-3xl">
        <div className="flex justify-between align-middle mb-6">
          ...
          <div className="flex space-x-5">
            <p className="text-sm flex items-center text-blue-steel">
              <div className="h-4 w-4 rounded-sm inline-block bg-[#1A16F3] me-2"></div>{" "}
              Debit
            </p>

            <p className="text-sm flex items-center text-blue-steel">
              <div className="h-4 w-4 rounded-sm inline-block bg-[#FCAA0B] me-2"></div>{" "}
              Debit
            </p>
          </div>
        </div>
