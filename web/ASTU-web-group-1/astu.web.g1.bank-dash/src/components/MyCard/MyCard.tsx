...
const MyCard = () => {
  return (
    <div className='w-[335px] h-[205px] bg-grad-end text-white  border rounded-3xl flex flex-col justify-between'>
      ...
      <div className='rounded-b-3xl flex justify-between px-6 py-4 bg-gradient-to-b from-grad-start to-grad-end'>
        <div className='flex'>
          <span className='text-18px font-text-navy'>3778 **** **** 1234</span>
        </div>
