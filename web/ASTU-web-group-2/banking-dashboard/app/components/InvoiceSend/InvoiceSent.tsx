...
const InvoicesSent = () => {
  return (
    <div className='w-[350px] mx-auto h-auto'>
      <h1 className='mb-[18px] text-[22px] flex-initial text-[#333B69] font-semibold'>Invoices Sent</h1>
      <div className='flex flex-col gap-6 bg-white drop-shadow-xl font-medium rounded-[25px] p-[25px]'>
          {recentlistitems.map((value, index) => (
            <div key={index} className='flex items-center gap-3'>
              ...
              <p className='text-lg ml-auto text-[#718EBF]'>
                {value.amount}
              </p>
            </div>
          ))}
