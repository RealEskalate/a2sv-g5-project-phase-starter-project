...
function WeeklyActivityChart() {
  ...
  if (isLoading) {
    return (
      <div className="flex justify-center items-center flex-col flex-initial flex-wrap bg-white lg:w-[730px] px-5 lg:h-[367px] md:w-[520px] md:h-[299px] w-[325px] h-[254px] rounded-[22px]">
