...
function WeeklyActivityChart() {
  ...
  return (
    <div className="">
      <div className="text-gray-500 border rounded-[22px] bg-white lg:w-[730px] px-5 lg:h-[367px] md:w-fit md:h-[299px] w-auto h-[254]">
        ...
        <div>
          <div className="weekly-activity-chart ml-5 lg:w-[667px] lg:h-[310px] md:w-[487px] md:h-[204px] w-[325px] h-[204px]">
            <canvas ref={chartRef} />
          </div>
        </div>
      </div>
